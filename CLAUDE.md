...
Gantty is a WBS (Work Breakdown Structure) and Gantt chart editor for planning project scope and schedule.

## Development

This is a new project. Build commands, test commands, and architecture documentation will be added as the project develops.

## Testing Requirements (テストコード作成時の厳守事項)
